...
function fuzzysortNew(instanceOptions) {
  var fuzzysort = {
    single: function (search, target, options) {
      ...
      var allowTypo = options && options.allowTypo !== undefined
        ? options.allowTypo
    ...
    go: function (search, targets, options) {
      ...
      var threshold = options && options.threshold ||
        instanceOptions && instanceOptions.threshold || -9007199254740991;
      var limit = options && options.limit ||
        instanceOptions && instanceOptions.limit || 9007199254740991;
      var allowTypo = options && options.allowTypo !== undefined
        ? options.allowTypo
        : instanceOptions && instanceOptions.allowTypo !== undefined
        ? instanceOptions.allowTypo
    ...
    algorithm: function (searchLowerCodes, prepared, searchLowerCode) {
        ...
        if (isMatch) {
          ...
          searchLowerCode = searchLowerCodes[
            typoSimpleI === 0
              ...
              : (typoSimpleI === searchI
                ? searchI + 1
                : (typoSimpleI === searchI - 1 ? searchI - 1 : searchI))
          ];
        }
      ...
      if (nextBeginningIndexes === null) {
        nextBeginningIndexes = prepared._nextBeginningIndexes = fuzzysort
          .prepareNextBeginningIndexes(prepared.target);
      }
      var firstPossibleI = targetI = matchesSimple[0] === 0
        ? 0
      ...
      if (targetI !== targetLen) {
        for (;;) {
          if (targetI >= targetLen) {
            ...
            var isMatch = searchLowerCodes[
              typoStrictI === 0
                ? searchI
                : (typoStrictI === searchI
                  ? searchI + 1
                  : (typoStrictI === searchI - 1 ? searchI - 1 : searchI))
    ...
    prepareBeginningIndexes: function (target) {
      ...
      for (var i = 0; i < targetLen; ++i) {
        ...
        var isAlphanum = isUpper || targetCode >= 97 && targetCode <= 122 ||
    ...
    prepareNextBeginningIndexes: function (target) {
      ...
      for (var i = 0; i < targetLen; ++i) {
        if (lastIsBeginning > i) {
          ...
          nextBeginningIndexes[i] = lastIsBeginning === undefined
            ? targetLen
            : lastIsBeginning;
        }
      }
...
export const fuzzysort = fuzzysortNew();
